...
## Project Structure
    ...
    ├── testapiautodatamod_107396  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_107396`
...
2. Clone this repo and `cd testapiautodatamod_107396`
